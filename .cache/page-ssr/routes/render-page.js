...
// EXTERNAL MODULE: external "/Users/andrel/gaweki-website/node_modules/react/index.js"
var index_js_ = __webpack_require__(3644);
...
var _react = _interopRequireDefault(__webpack_require__(3644));
...
const React=__webpack_require__(3644);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(1010);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
if(style){var _htmlAndBodyAttribute;htmlAndBodyAttributes[rawTagName].style={...((_htmlAndBodyAttribute=htmlAndBodyAttributes[rawTagName])===null||_htmlAndBodyAttribute===void 0?void 0:_htmlAndBodyAttribute.style),...styleToOjbect(style)};}}else{let element;const attributes={...node.attributes,"data-gatsby-head":true};if(rawTagName===`script`||rawTagName===`style`){element=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(node.rawTagName,{...attributes,dangerouslySetInnerHTML:{__html:node.text}});}else{element=node.textContent.length>0?/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(node.rawTagName,{...attributes,children:node.textContent}):/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(node.rawTagName,{...attributes});}if(id){if(!seenIds.has(id)){validHeadNodes.push(element);seenIds.set(id,validHeadNodes.length-1);}else{const indexOfPreviouslyInsertedNode=seenIds.get(id);validHeadNodes[indexOfPreviouslyInsertedNode]=element;}}else{validHeadNodes.push(element);}}}else{warnForInvalidTag(rawTagName);}if(node.childNodes.length){validHeadNodes.push(...getValidHeadNodesAndAttributesSSR(node,htmlAndBodyAttributes).validHeadNodes);}}return{validHeadNodes,htmlAndBodyAttributes};}function headHandlerForSSR({pageComponent,setHeadComponents,setHtmlAttributes,setBodyAttributes,staticQueryContext,pageData,pagePath}){if(pageComponent!==null&&pageComponent!==void 0&&pageComponent.Head){headExportValidator(pageComponent.Head);function HeadRouteHandler(props){var _pageData$result,_pageData$result$page;const _props={...props,...pageData.result,params:{...grabMatchParams(props.location.pathname),...(((_pageData$result=pageData.result)===null||_pageData$result===void 0?void 0:(_pageData$result$page=_pageData$result.pageContext)===null||_pageData$result$page===void 0?void 0:_pageData$result$page.__params)||{})}};const HeadElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(pageComponent.Head,{...filterHeadProps(_props)});const headWithWrapRootElement=(0,_api_runner_ssr__WEBPACK_IMPORTED_MODULE_0__.apiRunner)(`wrapRootElement`,{element:HeadElement},HeadElement,({result})=>{return{element:result};}).pop();return headWithWrapRootElement;}const routerElement=/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(StaticQueryContext.Provider,{value:staticQueryContext,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(ServerLocation,{url:`${""}${pagePath}`,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(Router,{baseuri:"",component:({children})=>/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment,{children:children}),children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(HeadRouteHandler,{path:"/*"})})})});const rawString=renderToString(routerElement);const rootNode=parse(rawString);const{validHeadNodes,htmlAndBodyAttributes}=getValidHeadNodesAndAttributesSSR(rootNode);applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes});setHeadComponents(validHeadNodes);}}
...
"use strict";
module.exports = require("/Users/andrel/gaweki-website/node_modules/react-dom/server.js");
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(3644),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3644);
...
var React = _interopRequireWildcard(__webpack_require__(3644));
...
"use strict";
module.exports = require("/Users/andrel/gaweki-website/node_modules/react/index.js");
...
var _react = __webpack_require__(3644);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(3644),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
exports.components={"component---src-pages-404-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-jsx */ 415).then(__webpack_require__.bind(__webpack_require__, 3729)),"component---src-pages-index-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-jsx */ 279).then(__webpack_require__.bind(__webpack_require__, 7325)),"component---src-pages-profile-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-profile-jsx */ 436).then(__webpack_require__.bind(__webpack_require__, 6630)),"component---src-pages-projects-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-projects-jsx */ 311).then(__webpack_require__.bind(__webpack_require__, 7811))};
...
"use strict";
module.exports = require("/Users/andrel/gaweki-website/.cache/ssr-builtin-trackers/fs");
...
/******/ 			return "" + {"279":"component---src-pages-index-jsx","311":"component---src-pages-projects-jsx","415":"component---src-pages-404-jsx","436":"component---src-pages-profile-jsx"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1915);
const React=__webpack_require__(3644);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1010);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(9399);const{WritableAsPromise}=__webpack_require__(5297);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
